...
//   const [user_type, setUserType] = useState('customer'); // Default to customer
...
//           navigate('/', { replace: true }); // Change to your actual customer home route
//         } else if (user_type === 'transporter') {
//           navigate('/owner', { replace: true }); // Change to your actual transporter home route
//         }
//       } else {
...
//       style={{
//         backgroundImage:
//           "url('https://corlettexpress.com/wp-content/uploads/2020/09/AdobeStock_244807532-2048x1024.jpeg')", // Replace with your image URL
//       }}
//     >
